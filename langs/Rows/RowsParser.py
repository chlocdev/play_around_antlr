...
class RowsParser ( Parser ):
    ...
    def file_(self):
        ...
        localctx = RowsParser.FileContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                localctx._STUFF = self.match(RowsParser.STUFF)
                        ...
                        localctx.i++;
                        if ( localctx.i == col ) System.out.println((None if localctx._STUFF is None else localctx._STUFF.text));
