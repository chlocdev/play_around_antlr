'''
python langs/Assignment/visualize_tree.py langs/Assignment/examples/assign.txt
'''
import os
import sys
from antlr4 import *
from AssignmentLexer import AssignmentLexer as Lexer
from AssignmentParser import AssignmentParser as Parser
