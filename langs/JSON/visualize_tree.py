'''
python langs/JSON/visualize_tree.py langs/JSON/examples/example.json
'''
import os
import sys
import time
...
from JSONParser import JSONParser as Parser
...
def visualize_parse_tree(input_string)->None:
    ...
    tree = parser.json() # custom here
    end_time = time.time()  -start_time
    print(f"Consumming time: {end_time:.4f} (s)")
